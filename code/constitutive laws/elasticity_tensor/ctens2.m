%--------------------------------------------------------------------------
% Evaluates the constitutive tensor (Mooney-Rivlin) for material type 2.
%--------------------------------------------------------------------------
...
c_iso        = 2*mu*(B*B-1/2*(B*B))-2/3*(mu+2*mu*I_1)*(B*D4+B*D3)+...
               4/*mu*(B*B*D4 + B*B*D3) + 2/9*(mu*I_1+4*mu*I_2)*D1+...
               1/3*(mu*I_1 + 2*mu*I_2)*D2;
c            = c_vol + C_iso;
end
