%--------------------------------------------------------------------------
% Evaluates the constitutive tensor (in Voigt notation) for material type 50.
%--------------------------------------------------------------------------
function c  = ctens50(kinematics,properties,cons,dimension)
mu          = properties(2);
Ib          = kinematics.Ib;
J           = kinematics.J;
switch dimension
